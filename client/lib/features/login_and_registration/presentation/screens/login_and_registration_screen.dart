...
class _LoginAndRegistrationScreenState
  ...
  void initState() {
    ...
    loginContent({String? email}) => LoginContent(
        email: email,
        notifyError: notifyError,
        goToLogin: (message, email) =>
            (goToLoginHelper[0] as GoToLoginCallback)(message, email));
    goToLoginHelper.add((message, email) => setState(() {
            ...
            child: Column(
              ...
              children: [
                ...
                ValueListenableBuilder(
                    ...
                    builder: (context, error, widget) => error == null ||
                            error.isEmpty
                        ? Container()
                        : Column(
                            children: [
                ...
                Align(
                  ...
                  child: InkWell(
                    child: Ink(
                      child: Text(content.nextContent.title,
                          style: const TextStyle(
                              color: Colors.white,
                              letterSpacing: 1,
