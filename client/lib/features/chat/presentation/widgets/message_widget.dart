...
import 'package:client/features/chat/presentation/widgets/message_status_widget.dart';
...
class MessageSideWidget extends StatelessWidget {
  ...
  const MessageSideWidget(
      {super.key, required this.message, required this.showSenderInfo});
              ...
              children: [
                if (isLeftSide && message.isGroup && showSenderInfo)
                  StreamBuilder<UserPublic>(
                      stream: getIt
                          .get<UsersService>()
                          .streamPublicUser(uid: message.senderUid),
