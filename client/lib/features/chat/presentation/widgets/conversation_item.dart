  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      ...
      child: Dismissible(
          ...
          direction: removeConversationCallback != null
          ...
          //           context: context,
          //           message: isGroup
          //               ? "You will leave $title"
          //               : "This conversation will be deleted",
          //           confirmButtonText: isGroup ? "EXIT GROUP" : "DELETE")
          //       .then((confirmed) {
          //     if (confirmed) {
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(
                          ...
                          color: Colors.white),
                      Text(
                        isGroup ? "Exit group" : "Delete for me",
                        style: TextStyle(
                            fontSize: 14,
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                      ...
                      border: !selected
                          ? null
                          : Border.all(width: 4, color: Colors.indigo[900]!)),
                  padding: const EdgeInsets.only(
                      top: 12, right: 18, left: 18, bottom: 6),
                  child: Column(
                    children: [
                      StreamBuilder<int>(
                        // stream: conversationId == null || lastMessage == null
                        //     ? Stream.value(0)
                        //     : getIt
                        //         .get<MessagesService>()
                        //         .pendingReadMessagesAmount(
                        //             conversationId: conversationId!),
                        stream: Stream.value(0),
                        initialData: 0,
                        builder: (context, pendingReadMessagesAmountSnapshot) {
                          final hasPendingMessages =
                              (pendingReadMessagesAmountSnapshot.data ?? 0) > 0;
                                        ...
                                        Expanded(
                                            child: Text(title,
                                                ...
                                                style: TextStyle(
                                                    ...
                                                    fontSize: 18,
                                                    color: Colors.white))),
                                        if (lastMessage?.hasPendingWrites ==
                                            false)
                                          Text(
                                            DateFormat('HH:mm')
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        if (typingUsers.isNotEmpty)
                                          Expanded(
                                            child: Text(
                                                _formattedTypingMessage(
                                                    typingUsers),
                                                style: const TextStyle(
                                                    fontWeight: FontWeight.w700,
                                                    fontSize: 14,
                                                    color: Color(0xff00eb1f))),
                                          ),
                                          ...
                                          Builder(
                                            builder: (context) {
                                              ...
                                              return Container(
                                                ...
                                                child: Center(
                                                  child: Text(
                                                      ((pendingReadMessagesAmountSnapshot
                                                                      .data ??
                                                                  0) >
                                                              9
                                                          ? '+9'
